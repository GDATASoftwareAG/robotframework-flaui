...
- Keyword Get Property From Element extended with LegacyIAccessible pattern operations
  ...
  - LEGACY_IACCESSIBLE_ROLE
  - LEGACY_IACCESSIBLE_NAME
  - LEGACY_IACCESSIBLE_VALUE
  - LEGACY_IACCESSIBLE_DEFAULT_ACTION
  - LEGACY_IACCESSIBLE_DESCRIPTION
  - LEGACY_IACCESSIBLE_HELP
  - LEGACY_IACCESSIBLE_KEYBOARD_SHORTCUT
  - LEGACY_IACCESSIBLE_CHILD_ID
  - LEGACY_IACCESSIBLE_IS_EXPANDED
  - LEGACY_IACCESSIBLE_IS_COLLAPSED

## [Release][5.0.0] [5.0.0][4.1.1-5.0.0] - 2026-05-25
...
- [#233](https://github.com/GDATASoftwareAG/robotframework-flaui/issues/233) New keyword to set screenshot file suffix
...
- [#135](https://github.com/GDATASoftwareAG/robotframework-flaui/issues/135)
...
[4.1.1-5.0.0]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/4.1.1...5.0.0
...
[4.0.0-4.0.1]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/4.0.0...4.0.1
...
[3.0.1-3.0.2]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/3.0.1...3.0.2

[3.0.1]: https://github.com/GDATASoftwareAG/robotframework-flaui/releases/tag/3.0.1

[3.0.0-3.0.1]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/3.0.0...3.0.1

[3.0.0]: https://github.com/GDATASoftwareAG/robotframework-flaui/releases/tag/3.0.0

[2.1.3-3.0.0]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/2.1.3...3.0.0
...
[2.0.15-2.0.16]: https://github.com/GDATASoftwareAG/robotframework-flaui/compare/2.0.15...2.0.16
