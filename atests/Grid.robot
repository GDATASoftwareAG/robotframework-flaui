...
Get Grid Rows Count
    ${COUNT}  Get Listview Rows Count  ${XPATH_GRID_VIEW}
    Should Be Equal As Integers  ${COUNT}  3

Select Grid Row By Index
    Element Should Exist  ${XPATH_GRID_VIEW}
    Select Listview Row By Index  ${XPATH_GRID_VIEW}  1
    ${DATA}  Get Selected Listview Rows  ${XPATH_GRID_VIEW}
...
Select Grid Item Wrong Index Usage
    ...
    Run Keyword and Expect Error  ${EXP_ERR_MSG}  Select Listview Row By Index  ${XPATH_GRID_VIEW}  NOT_AN_ARRAY

Select Grid Row By Name
    Select Listview Row By Name  ${XPATH_GRID_VIEW}  0  Doe
    ${DATA}  Get Selected Listview Rows  ${XPATH_GRID_VIEW}
    Should Contain  ${DATA}  | Doe | 24 |
...
Select Grid Item By Name Wrong Name Or Index
    ...
    Run Keyword and Expect Error   ${EXP_ERR_MSG}  Select Listview Row By Name  ${XPATH_GRID_VIEW}  -2000  Simple item which does not exist

Select Grid Item By Name Wrong Index Usage
    ${EXP_ERR_MSG}  Format String  ${EXP_ERR_MSG_VALUE_SHOULD_BE_A_NUMBER}  NOT_AN_ARRAY  ${XPATH_GRID_VIEW}
    Run Keyword and Expect Error  ${EXP_ERR_MSG}  Select Listview Row By Name  ${XPATH_GRID_VIEW}   NOT_AN_ARRAY   Simple item 1

Select Multiple Grid Items
    Select Listview Row By Name   ${XPATH_GRID_VIEW}  0  Doe
    Select Listview Row By Index  ${XPATH_GRID_VIEW}  0
    ${DATA}  Get Selected Listview Rows  ${XPATH_GRID_VIEW}
